...
feature.salmon.counts.annot <- inner_join(feature.salmon.counts, gene_info, by = "gene") %>%
  dplyr::arrange(-percentage_diff) %>%
...
ggplot(feature.salmon.counts.annot, 
       aes(x=log2(feature.salmon.counts.annot$featurecounts+1), y=log2(feature.salmon.counts.annot$salmoncounts+1))) +
         geom_point() +
