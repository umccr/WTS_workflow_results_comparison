...
output:
  ...
  rmdformats::material:
    highlight: kate
params:
  run_1: '/Users/kanwals/UMCCR/data/projects/WTS_comparison/SBJ02097/dragen/'
  run_2: '/Users/kanwals/UMCCR/data/projects/WTS_comparison/SBJ02097/bcbio/'
---
...
counts.dragen.gene <- read.table(here("../../data/projects/WTS_comparison/SBJ02097/dragen/PRJ221038.quant.genes.sf"), sep="\t", as.is=TRUE, header=TRUE)
...
txi.bcbio <- tximport(here('../../data/projects/WTS_comparison/SBJ02097/bcbio/abundance.tsv'), type = "kallisto", tx2gene = tx2ensembl)
txi.dragen <- tximport(here('../../data/projects/WTS_comparison/SBJ02097/dragen/PRJ221038.quant.sf'), type = "salmon", tx2gene = tx2ensembl)
...
```{r summary-fusions, message=FALSE, warning=FALSE, echo =FALSE}
